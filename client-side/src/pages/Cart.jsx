...
function Cart() {
  return (
    <>
      <Navbar />
      <section className="w-full bg-[#f3f5f0] dark:bg-[#0A2025] py-9 px-8 ">
              ...
              <tfoot>
                <tr className="border-t border-gray-400">
                  <td className="px-2 py-2" colspan="3">
                    <button className="px-8 cursor-pointer py-3.5 bg-[#f2f2f2] rounded-[43px] text-[#4c4c4c] text-sm font-semibold classNameName leading-[16px]">
                      Return to shop
                    </button>
                  </td>
