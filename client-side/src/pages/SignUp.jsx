...
function SignUp() {
  ...
  <div className="bg-indigo-600 hidden lg:block w-full md:w-1/2 xl:w-2/3 h-screen">
    <img src={p12} alt="" className="w-full h-full object-cover"/>
  </div>
    ...
    <div className="w-full h-100">
      ...
      <form className="mt-6" action="#" method="POST">
        <div>
          ...
          <input type="text" name="" id="" placeholder="Enter User Name" className="w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-blue-500 focus:bg-white focus:outline-none" autofocus autocomplete required/>
        </div>
        <div>
